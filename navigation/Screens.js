...
import CreateBusiness from '../screens/createbusiness_screen.js'
...
function ClickStack(props) {
  return (
    <Stack.Navigator initialRouteName="Click" mode="card" headerMode="screen">
      <Stack.Screen
        name="Click"
        component={Clicks}
        options={{
...
function AppStack(props) {
  return (
    ...
    >
      ...
      <Drawer.Screen name="Click" component={ClickStack} /> 
